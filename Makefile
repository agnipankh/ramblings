...
thumbs:
	python "$(BASEDIR)/scripts/generate_thumbnails.py"
...
.PHONY: html help clean regenerate serve serve-global devserver devserver-global publish ssh_upload sftp_upload rsync_upload github thumbs
