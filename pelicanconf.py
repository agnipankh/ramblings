...
# Web-sized WebP derivatives live under images/thumbs/{card,featured,cover}/,
# generated by scripts/generate_thumbnails.py (wired into `make html`).
# Templates map cover paths onto them; originals are served untouched
